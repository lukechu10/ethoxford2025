...
const PostView: Component = () => {
  const [reviews, setReviews] = createSignal<{ text: string; votes: number }[]>([]); 
...
<div class="post-view-container">
  ...
  <div class="voting-section">
    ...
    <button class="voting-button downvote" onClick={handlePostDownvote}>
      Downvote
    </button>
        ...
        reviews().map((review, index) => (
          <div class="review-item">
            <div>
              ...
              <p class="review-votes">Votes: {review.votes}</p>
            </div>
