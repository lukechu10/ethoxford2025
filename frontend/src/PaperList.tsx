		...
		<div class="max-w-prose mx-auto pt-5">
			...
			<ul>
				<Show when={papers()}>
					<For each={papers()}>
						{(paper) => (
							<A href={`/paper/${paper.id}`} class="flex flex-row bg-gray-900 my-4 p-4 rounded-xl transition hover:-translate-y-1 hover:bg-linear-to-br hover:from-orange-700 hover:to-orange-800 group">
								...
								<div>
									...
									<p class="text-sm text-primary-content">
										...
										<span class="ml-10">
											Author: 
											<span class="font-bold text-orange-200">{paper.author.substring(0, 10)}...</span>
										</span>
									</p>
